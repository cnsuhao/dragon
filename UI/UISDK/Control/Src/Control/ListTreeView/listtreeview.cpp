...
void ListTreeViewCtrlBase::OnDrawMainItem(IRenderTarget* pRenderTarget, ListTreeViewItem* pItem, const CRect* prcItem, int nRenderState)
{
	...
	rcItem.left += m_nChildNodeIndent*pItem->CalcDepth();
...
bool ListTreeViewCtrlBase::InsertColumn(int nColumn, LPCTSTR szText, int nWidth, int nFormat)
{
	if (NULL == m_pHeaderCtrl)
	{
...
bool ListTreeViewCtrlBase::SetItemText(UIHTREEITEM hTreeItem, int nSubItem, LPCTSTR szText, bool bUpdate)
{
