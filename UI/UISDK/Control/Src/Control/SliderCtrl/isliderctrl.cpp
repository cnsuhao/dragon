...
namespace UI
{
UI_IMPLEMENT_Ixxx_INTERFACE_ACROSSMODULE(ISliderCtrl, SliderCtrl, IControl)
...
void  ISliderCtrl::SetDirectionType(PROGRESSBAR_SCROLL_DIRECTION_TYPE eType) { m_pSliderCtrlImpl->SetDirectionType(eType); }
PROGRESSBAR_SCROLL_DIRECTION_TYPE  ISliderCtrl::GetDirectionType() { return m_pSliderCtrlImpl->GetDirectionType(); }
