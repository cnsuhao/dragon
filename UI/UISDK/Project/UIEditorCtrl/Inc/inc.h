...
#ifdef UIEDITORCTRL_EXPORTS
#define UIEDITORCTRLAPI __declspec(dllexport)
#else
#define UIEDITORCTRLAPI __declspec(dllimport)
#endif

extern "C"
{
    UIEDITORCTRLAPI bool UIEditor_Ctrl_RegisterUIObject(UI::IUIApplication* p);

    UIEDITORCTRLAPI UINT  GetToolBoxItemDragClipboardFormat();
    UIEDITORCTRLAPI UINT  GetProjectTreeControlDragClipboardFormat();
