...
//     RenderBaseAttribute*  AddRenderBase(LPCTSTR szPrefix, LPCTSTR szKey, IObject* pObj, IRenderBase*& pBindValue);
//     TextRenderBaseAttribute*  AddTextRenderBase(LPCTSTR szPrefix, LPCTSTR szKey, IObject* pObj, ITextRenderBase*& pBindValue);
