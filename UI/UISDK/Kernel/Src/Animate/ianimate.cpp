...
void  IAnimateManager::ClearStoryboardOfNotify(IMessage* pMsg) 
{
    return m_pImpl->ClearStoryboardOfNotify(pMsg); 
}
void  IAnimateManager::RemoveStoryboard(IStoryboard* p)
{
    m_pImpl->RemoveStoryboard(p); 
}
void  IAnimateManager::RemoveStoryboard(IMessage* pMsg, int nId)
{
    m_pImpl->RemoveStoryboard(pMsg, nId);
}
IStoryboard*  IAnimateManager::CreateStoryboard(IMessage* pNotify, int nId, WPARAM wParam, LPARAM lParam)
{
    return m_pImpl->CreateStoryboard(pNotify, nId, wParam, lParam); 
}
