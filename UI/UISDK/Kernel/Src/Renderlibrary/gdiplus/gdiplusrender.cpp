...
//
void GdiplusRenderTarget::DrawRect(const RECT* lprc, UI::Color* pColor)
{
...
void  GdiplusRenderTarget::Render2Target(IRenderTarget* pDst, Render2TargetParam* pParam)
{
	...
	else if (pParam->pTransform3d)
	{
		...
		POINT  ptOffsetDst;
		pGdipDst->GetViewportOrgEx(&ptOffsetDst);
...
void  GdiplusRenderTarget::Upload2Gpu(IGpuLayerTexture* p, LPRECT prcArray, int nCount)
{
    if (m_pRenderBuffer)
    {
