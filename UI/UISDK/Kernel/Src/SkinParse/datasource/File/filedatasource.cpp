...
bool FileDataSource::Load_UIDocument(IUIDocument* pDocument, LPCTSTR szPath)
{
...
bool  FileDataSource::Load_RenderBitmap(IRenderBitmap* pBitmap, LPCTSTR szPath, bool bCreateAlphaChannel)
{
...
bool  FileDataSource::Load_Image(ImageWrap* pImage, LPCTSTR szPath)
{
