...
enum WINDOW_TRANSPARENT_TYPE
{
    ...
    WINDOW_TRANSPARENT_TYPE_AERO = 32,     // 注：如果在win7不支持aero情况下，该值可能为16|2，这样当恢复为支持aero主题时也能知道恢复成aero模式
...
#define XML_LAYOUT_FLAG_FORCE_DESIREDSIZE  _T("forcedesiredsize")
