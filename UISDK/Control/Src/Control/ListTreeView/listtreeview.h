...
public:
    ...
    UI_DECLARE_OBJECT(ListTreeView, OBJ_CONTROL|CONTROL_TREEVIEWCTRL);
...
private:
	...
	public:
		bool   InsertColumn(int nColumn, LPCTSTR szText, int nWidth, int nFormat=DT_LEFT|DT_SINGLELINE|DT_VCENTER|DT_END_ELLIPSIS);
		bool   SetItemText(UIHTREEITEM hTreeItem, int nSubItem, LPCTSTR szText, bool bUpdate);
