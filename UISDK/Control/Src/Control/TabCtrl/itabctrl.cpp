...
UI_IMPLEMENT_Ixxx_INTERFACE_ACROSSMODULE(ITabCtrlBase, TabCtrlBase, IPanel)
...
void  ITabCtrl::AddItem(LPCTSTR  szText, IObject* pContentObj) { return m_pTabCtrlImpl->AddItem(szText, pContentObj); }