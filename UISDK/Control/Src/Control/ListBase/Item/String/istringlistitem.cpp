...
UI_IMPLEMENT_Ixxx_INTERFACE_ACROSSMODULE(IStringListItem, StringListItem, IListItemBase);
UI_IMPLEMENT_Ixxx_INTERFACE_ACROSSMODULE(IStringListItemShareData, StringListItemShareData, IListItemTypeShareData);
