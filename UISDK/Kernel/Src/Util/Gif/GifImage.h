...
{
public:
	GifImageRender(GifImageBase* pGifImage, Gif_Timer_Notify* pNotify, IUIApplication*  pUIApp);
protected:
	~GifImageRender();
...
public:
	...
	GifImageRender*  AddRender(Gif_Timer_Notify* pNotify, IUIApplication*  pUIApp, int* pIndex = NULL);
