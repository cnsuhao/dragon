...
StringEnumAttribute*  StringEnumAttribute::FillRenderBaseTypeData()
{
    ...
    m_pUIApplication->EnumRenderBaseName(EnumRenderBaseNameCallback, (WPARAM)this, 0);
    return this;
}
...
{
    m_list.clear();
    m_pUIApplication->EnumTextRenderBaseName(EnumTextRenderBaseNameCallback, (WPARAM)this, 0);
    return this;
}

void  StringEnumAttribute::Editor(AttributeEditorProxy* p, EditorAttributeFlag e)
{
