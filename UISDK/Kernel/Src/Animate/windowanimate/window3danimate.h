...
public:
    ...
    float*  GetRotateXPtr() { return &m_nRotateX; }
    float*  GetRotateYPtr() { return &m_nRotateY; } 
    float*  GetRotateZPtr() { return &m_nRotateZ; } 
...
protected:
	...
	QuadPerspectiveTextureMapping  m_textmapping;
};
