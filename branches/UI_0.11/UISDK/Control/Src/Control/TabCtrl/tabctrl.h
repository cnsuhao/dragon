...
public:
    TabCtrlBase();
    ~TabCtrlBase();
    UI_DECLARE_OBJECT(TabCtrlBase, OBJ_PANEL|CONTROL_TABCTRL)
...
public:
    ...
    UI_DECLARE_OBJECT(TabCtrl, OBJ_PANEL|CONTROL_TABCTRL)
...
public:
    void  AddItem(LPCTSTR  szText, IObject* pContentObj);
private:
