...
HtmlParser::HtmlParser(RichTextObjectModel::Doc& doc) : m_refDoc(doc)
{
...
void  HtmlParser::AddText(LPCTSTR szText)
{
	...
	else
	{
		...
		m_refDoc.AppendText2(strDecode.c_str(), &cf);
	}
}
...
//  获取当前的字体样式
void  HtmlParser::GetCharFormatOnStack(RichTextCharFormat* pcf)
{
