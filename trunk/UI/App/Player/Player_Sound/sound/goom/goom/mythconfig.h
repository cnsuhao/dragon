...
#define FFMPEG_CONFIGURATION "--prefix=/usr/local --dvb-path=/usr/local/include --extra-cflags=-g --extra-cxxflags=-g --enable-v4l --enable-ivtv --enable-xvmc --disable-xvmcw --disable-directfb --disable-audio-alsa --without-bindings='perl,python' --enable-opengl-video --enable-opengl-vsync --disable-vdpau"
...
#define CONFIG_MPEG_XVMC_VLD_DECODER 0
...
#define CONFIG_SYMBOL_VISIBILITY 0
...
#define CONFIG_JOYSTICK_MENU 0
#define CONFIG_LIBFFTW3 0
#define CONFIG_LIBMPEG2EXTERNAL 0
#define CONFIG_LIRC 1
#define CONFIG_MHEG 1
#define CONFIG_OPENGL_VIDEO 1
#define CONFIG_OPENGL_VSYNC 1
#define CONFIG_QTDBUS 1
...
#define CONFIG_XVMC_VLD 0
#define CONFIG_XVMCW 0
#define MYTH_BUILD_CONFIG " freebsd release using_oss using_backend using_dvb using_frontend using_hdhomerun using_hdpvr using_iptv using_ivtv using_lirc using_mheg using_opengl_video using_opengl_vsync using_qtdbus using_qtwebkit using_v4l using_x11 using_xrandr using_mythtranscode using_opengl using_ffmpeg_threads using_live using_mheg"
