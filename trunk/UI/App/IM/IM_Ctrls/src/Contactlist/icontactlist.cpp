...
IContactListContactItem*  IContactList::InsertContact(CONTACTLIST_CONTACTITEM_INFO* pInfo, bool bCheckExist){
    return m_pContactListImpl->InsertContact(pInfo, bCheckExist); }
...
void  IContactListGroupItem::Update(CONTACTLIST_GROUPITEM_INFO* pInfo) { 
    return m_pContactListGroupItemImpl->Update(pInfo); }

//////////////////////////////////////////////////////////////////////////

void  IContactListContactItem::Update(CONTACTLIST_CONTACTITEM_INFO* pInfo) { 
    return m_pContactListContactItemImpl->Update(pInfo); }