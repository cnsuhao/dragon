...
//
BOOL CalcRelativePathToDir(LPCTSTR szDir, LPCTSTR szPath, TCHAR* szOutRelativePath )
{
...
//
BOOL CalcRelativePathToFile(LPCTSTR szFile, LPCTSTR szPath, TCHAR* szOutRelativePath)
{
...
// 遍历文件夹
BOOL EnumFileInDirectory(LPCTSTR szDir, EnumFileInDirProc proc, WPARAM wParam)
{
