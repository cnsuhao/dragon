...
{
    m_pListItemBaseImpl->SetIListCtrlBase(p); 
}
IListCtrlBase*  IListItemBase::GetIListCtrlBase()                 
{
    return m_pListItemBaseImpl->GetIListCtrlBase(); 
}
...
bool  IListItemBase::IsMyChildItem(IListItemBase* pChild, bool bTestdescendant)
{
    ...
    return m_pListItemBaseImpl->IsMyChildItem(pChild->GetImpl(), bTestdescendant);
}
...
const CRect*  IListItemBase::GetParentRectPtr()                                  
{
    return m_pListItemBaseImpl->GetParentRectPtr(); 
}
void  IListItemBase::GetParentRect(CRect* prc)                                
{
    m_pListItemBaseImpl->GetParentRect(prc); 
}
void  IListItemBase::SetParentRect(CRect* prc)                                
{
    m_pListItemBaseImpl->SetParentRect(prc); 
}

int   IListItemBase::GetItemType()                                            
{ 
    return m_pListItemBaseImpl->GetItemType(); 
}
void  IListItemBase::SetItemType(long n)                                      
{
    m_pListItemBaseImpl->SetItemType(n); 
}
long  IListItemBase::GetId()                                                 
{
    return m_pListItemBaseImpl->GetId(); 
}
void  IListItemBase::SetId(long n)                                            
{
    return m_pListItemBaseImpl->SetId(n); 
}
void  IListItemBase::SetText(const TCHAR* szText)                             
{ 
    m_pListItemBaseImpl->SetText(szText); 
}
const TCHAR*  IListItemBase::GetText()                                        
{
    return m_pListItemBaseImpl->GetText(); 
}
void  IListItemBase::SetToolTip(const TCHAR* szText)                          
{
    return m_pListItemBaseImpl->SetToolTip(szText); 
}
UINT  IListItemBase::GetItemFlag()                                            
{
    return m_pListItemBaseImpl->GetItemFlag(); 
}
void  IListItemBase::SetItemFlag(int n)                                       
{
    m_pListItemBaseImpl->SetItemFlag(n); 
}
const TCHAR*  IListItemBase::GetToolTip()                                     
{
    return m_pListItemBaseImpl->GetToolTip(); 
}
LPARAM  IListItemBase::GetData()                                              
{
    return m_pListItemBaseImpl->GetData(); 
}
void  IListItemBase::SetData(LPARAM p)                                       
{
    m_pListItemBaseImpl->SetData(p); 
}
LPARAM  IListItemBase::GetCtrlData()                                          
{
    return m_pListItemBaseImpl->GetCtrlData(); 
}
void  IListItemBase::SetCtrlData(LPARAM p)                                    
{
    m_pListItemBaseImpl->SetCtrlData(p); 
}
void  IListItemBase::GetDesiredSize(SIZE* pSize)                              
{
    UISendMessage(this, UI_WM_GETDESIREDSIZE, (WPARAM)pSize); 
}
int   IListItemBase::GetLineIndex()                                           
{
    return m_pListItemBaseImpl->GetLineIndex(); 
}
void  IListItemBase::SetLineIndex(int n)                                      
{ 
    m_pListItemBaseImpl->SetLineIndex(n); }
int   IListItemBase::GetTreeIndex()                                           
{ 
    return m_pListItemBaseImpl->GetTreeIndex(); 
}
int   IListItemBase::GetNeighbourIndex()                                      
{
    return m_pListItemBaseImpl->GetNeighbourIndex(); 
}
void  IListItemBase::SetTreeIndex(int n)                                      
{
    m_pListItemBaseImpl->SetTreeIndex(n); 
}
void  IListItemBase::SetNeighbourIndex(int n)                                 
{
    m_pListItemBaseImpl->SetNeighbourIndex(n);
}
int   IListItemBase::CalcDepth()
{
    return m_pListItemBaseImpl->CalcDepth();
}
void  IListItemBase::SetConfigWidth(int n)                                    
{
    m_pListItemBaseImpl->SetConfigWidth(n); 
}
void  IListItemBase::SetConfigHeight(int n)                               {
    m_pListItemBaseImpl->SetConfigHeight(n);
}
int  IListItemBase::GetConfigWidth()
{
    return m_pListItemBaseImpl->GetConfigWidth();
}
int  IListItemBase::GetConfigHeight()
{
    return m_pListItemBaseImpl->GetConfigHeight();
}

IRenderBase*  IListItemBase::GetIconRender()                                 
{
    return m_pListItemBaseImpl->GetIconRender(); 
}
void  IListItemBase::SetIconRender(IRenderBase* p)                            
{ 
    m_pListItemBaseImpl->SetIconRender(p); 
}
void  IListItemBase::SetIconRenderType(RENDER_TYPE eType)                     
{
    m_pListItemBaseImpl->SetIconRenderType(eType); 
}
void  IListItemBase::SetIconFromFile(const TCHAR* szIconPath)                 
{
    m_pListItemBaseImpl->SetIconFromFile(szIconPath); 
}
void  IListItemBase::SetIconFromImageId(const TCHAR* szImageId)               
{
    m_pListItemBaseImpl->SetIconFromImageId(szImageId); 
}

UINT  IListItemBase::GetItemState()                                           
{ 
    return m_pListItemBaseImpl->GetItemState(); 
}
bool  IListItemBase::IsMySelfVisible()                                       
{
    return m_pListItemBaseImpl->IsMySelfVisible(); 
}
bool  IListItemBase::IsVisible()                                             
{
    return m_pListItemBaseImpl->IsVisible(); 
}
bool  IListItemBase::IsDisable()                                              
{
    return m_pListItemBaseImpl->IsDisable(); 
}
bool  IListItemBase::IsHover()                                                
{
    return m_pListItemBaseImpl->IsHover(); 
}
bool  IListItemBase::IsPress()                                                
{ 
    return m_pListItemBaseImpl->IsPress(); 
}
bool  IListItemBase::IsFocus()                                               
{
    return m_pListItemBaseImpl->IsFocus(); 
}
bool  IListItemBase::IsCollapsed()                                           
{
    return m_pListItemBaseImpl->IsCollapsed(); 
}
bool  IListItemBase::IsExpand()                                               
{
    return m_pListItemBaseImpl->IsExpand(); 
}
bool  IListItemBase::IsSelected()                                            
{
    return m_pListItemBaseImpl->IsSelected(); 
}
bool IListItemBase::IsSelectable()
{
    return m_pListItemBaseImpl->IsSelectable();
}
bool  IListItemBase::IsChecked()                                              
{
    return m_pListItemBaseImpl->IsChecked(); 
}
bool  IListItemBase::IsRadioChecked()                                        
{
    return m_pListItemBaseImpl->IsRadioChecked(); 
}
void  IListItemBase::SetPress(bool b, bool bNotify)                           
{
    m_pListItemBaseImpl->SetPress(b, bNotify); 
}
void  IListItemBase::SetHover(bool b, bool bNotify)                          
{
    m_pListItemBaseImpl->SetHover(b, bNotify); 
}
void  IListItemBase::SetExpand(bool b, bool bNotify)                          
{
    m_pListItemBaseImpl->SetExpand(b, bNotify); 
}
void  IListItemBase::SetFocus(bool b, bool bNotify)                           
{
    m_pListItemBaseImpl->SetFocus(b, bNotify); 
}
void  IListItemBase::SetSelected(bool b, bool bNotify)                        
{
    m_pListItemBaseImpl->SetSelected(b, bNotify); 
}
void  IListItemBase::SetDisable(bool b, bool bNotify)                        
{
    m_pListItemBaseImpl->SetDisable(b, bNotify); 
}
void  IListItemBase::SetChecked(bool b, bool bNotify)                        
{
    m_pListItemBaseImpl->SetChecked(b, bNotify); 
}
void  IListItemBase::SetRadioChecked(bool b, bool bNotify)                    
{
    m_pListItemBaseImpl->SetRadioChecked(b, bNotify); 
}
bool  IListItemBase::IsDragDropHover()
{
    return m_pListItemBaseImpl->IsDragDropHover();
}
void  IListItemBase::SetDragDropHover(bool b, bool bNotify)
{
    m_pListItemBaseImpl->SetDragDropHover(b, bNotify);
}
void  IListItemBase::SetSelectable(bool b)
{
    m_pListItemBaseImpl->SetSelectable(b);
}

IPanel*  IListItemBase::GetRootPanel()                                       
{
    return m_pListItemBaseImpl->GetRootPanel(); 
}
bool  IListItemBase::CreateRootPanel()                                       
{
    return m_pListItemBaseImpl->CreateRootPanel(); 
}
void  IListItemBase::DrawItemInnerControl(IRenderTarget* pRenderTarget, RenderContext* prenderContext)       
{
    m_pListItemBaseImpl->DrawItemInnerControl(pRenderTarget, prenderContext); 
}
...
{
    return m_pListItemBaseImpl->GetItemDelayOp(); 
}
void  IListItemBase::AddItemDelayOp(int n)                                    
{
    m_pListItemBaseImpl->AddItemDelayOp(n); 
}
void  IListItemBase::RemoveDelayOp(int n)                                    
{
    m_pListItemBaseImpl->RemoveDelayOp(n); 
}
void  IListItemBase::ClearDelayOp()
{
    m_pListItemBaseImpl->ClearDelayOp(); 
}
long  IListItemBase::GetSort()
{
    return m_pListItemBaseImpl->GetSort();
}
void  IListItemBase::SetSort(long l)
{
    m_pListItemBaseImpl->SetSort(l);
}
