...
public:
    ...
    static Object*  GetObjectByPos(Object* pObjParent, POINT* ptWindow, __out POINT* ptObj);
    static Object*  GetObjectByPos_UIEditor(Object* pObjParent, POINT* pt, __out POINT* ptOutInObj);
