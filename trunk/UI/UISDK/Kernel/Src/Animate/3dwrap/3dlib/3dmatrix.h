...
namespace UI
{
	...
	void  Mat_Move_4X4(MATRIX_4_4_PTR m, float x, float y, float z);
	void  Mat_Rotate_4X4(MATRIX_4_4_PTR m, float x, float y, float z);
	int   Mat_Inverse_3X3(MATRIX_3_3_PTR m, MATRIX_3_3_PTR mi);
#endif
}