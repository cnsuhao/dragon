...
#define LISTITEM_OPFLAG_NOUPDATEITEMINDEX  0x0008    // 不去更新索引
#define LISTITEM_OPFLAG_NOALL   (LISTITEM_OPFLAG_NOREDRAW|LISTITEM_OPFLAG_NOUPDATEITEMRECT|LISTITEM_OPFLAG_NOSORT|LISTITEM_OPFLAG_NOUPDATEITEMINDEX)
